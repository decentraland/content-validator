...
import { OnChainAccessCheckerComponents, ValidateFn, validationFailed, ValidationResponse } from '../../../types'
...
export type AssetValidation = {
  validateAsset(
    components: Pick<OnChainAccessCheckerComponents, 'externalCalls'>,
