...
export async function deploymentMaxSizeExcludingThumbnailIsNotExceeded(
 ...
 * * @public
 */
export const items: ValidateFn = validateIfConditionMet(
  (deployment) => deployment.entity.type === EntityType.WEARABLE || deployment.entity.type === EntityType.EMOTE,
  validateAfterADR45(validateAll(thumbnailMaxSizeIsNotExceeded, deploymentMaxSizeExcludingThumbnailIsNotExceeded))
)
